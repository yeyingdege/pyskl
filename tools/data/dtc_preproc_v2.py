...
def read_annotations(dir_path, label_to_id, frame_thres, multi_label, files=None):
...
def main():
    ...
    train_anns, train_ids = read_annotations(args.annotation_dir, label_to_id, args.frame_thres, args.multi_label, files=train)
    val_anns, val_ids = read_annotations(args.annotation_dir, label_to_id, args.frame_thres, args.multi_label, files=val)
